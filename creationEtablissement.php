...
echo "  <a href='css/bootstrap-3.0.0' ' class='navbar-brand'>Bootswatch</a>
...
<form method='POST' action='creationEtablissement.php?'>
   ...
   <table class='table table-striped'>
      ...
      <tr class="ligneTabNonQuad">
         <td> Téléphone*: </td>
         <td><input type="tel" pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$" value="'.$tel.'" name="tel" size ="20" 
         maxlength="10"></td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> E-mail: </td>
